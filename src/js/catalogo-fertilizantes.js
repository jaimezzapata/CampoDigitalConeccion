function createElem(type, classNames = [], attrs = {}) {
  ...
  function buildPage() {
    ...
    row1.appendChild(crearCardProducto('../imagen/img-fertilizantes/1.svg', 'Abono orgánico Biocare 10Kg', '$27.900'));
    row1.appendChild(crearCardProducto('../imagen/img-fertilizantes/2.svg', 'Tierra para Jardinería', '$7.900'));
    row1.appendChild(crearCardProducto('../imagen/img-fertilizantes/3.svg', 'Fertilizante Natural', '$11.900'));
    ...
    row2.appendChild(crearCardProducto('../imagen/img-fertilizantes/4.svg', 'Fertilizante Rebrote 10kg', '$63.500'));
    row2.appendChild(crearCardProducto('../imagen/img-fertilizantes/5.svg', 'Hidrofollaje', '$25.600'));
    row2.appendChild(crearCardProducto('../imagen/img-fertilizantes/6.svg', 'Fertiespecial 46kg', '$93.300'));
    ...
    row3.appendChild(crearCardProducto('../imagen/img-fertilizantes/7.svg', 'Tierra Mejorada 2kg', '$9.900'));
    row3.appendChild(crearCardProducto('../imagen/img-fertilizantes/8.svg', 'Fuerza Concentrada', '$77.900'));
    row3.appendChild(crearCardProducto('../imagen/img-fertilizantes/9.svg', 'Fertilizante Vegano 2kg', '$25.000'));
